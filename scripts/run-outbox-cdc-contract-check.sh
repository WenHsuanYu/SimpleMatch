...
for topic in matching.commands account.lifecycle; do
...
cdc_capture_topic_end_offsets matching.commands "$risk_baseline"
psql_query <<SQL
INSERT INTO risk_service.outbox (
  ...
  (1, '00000000-0000-0000-0000-000000000001', 'matching.commands', 'risk-order-1', 2,
   decode('7269736b2d7061796c6f61642d7631', 'hex'), 'simplematch.matching.runtime.v1.MatchingCommand',
...
INSERT INTO account_service.outbox (
  ...
  (1, '00000000-0000-0000-0000-000000000002', 'account.lifecycle', 'account-1', NULL,
   decode('6163636f756e742d7061796c6f61642d7632', 'hex'), 'simplematch.account.v2.AccountLifecycleEvent',
...
cdc_capture_topic_end_offsets matching.commands "$risk_recovery_baseline"
psql_query <<SQL
INSERT INTO risk_service.outbox (
  id, event_id, topic, message_key, kafka_partition_id, payload, payload_type, headers_json,
  aggregate_type, aggregate_id, created_at_unix_ms, created_at
) VALUES
  (2, '00000000-0000-0000-0000-000000000004', 'matching.commands', 'risk-order-2', 2,
   decode('7269736b2d7061796c6f61642d7632', 'hex'), 'simplematch.matching.runtime.v1.MatchingCommand',
...
INSERT INTO account_service.outbox (
  ...
  (2, '00000000-0000-0000-0000-000000000005', 'account.lifecycle', 'account-2', NULL,
   decode('6163636f756e742d7061796c6f61642d7633', 'hex'), 'simplematch.account.v2.AccountLifecycleEvent',
...
cdc_capture_topic_end_offsets matching.commands "$risk_broker_baseline"
...
INSERT INTO risk_service.outbox (
  ...
  (3, '00000000-0000-0000-0000-000000000006', 'matching.commands', 'risk-order-3', 1,
   decode('7269736b2d70726f64756365722d6661696c757265', 'hex'), 'simplematch.matching.runtime.v1.MatchingCommand',
...
INSERT INTO account_service.outbox (
  ...
  (3, '00000000-0000-0000-0000-000000000007', 'account.lifecycle', 'account-3', NULL,
   decode('6163636f756e742d70726f64756365722d6661696c7572652d7632', 'hex'), 'simplematch.account.v2.AccountLifecycleEvent',
...
cdc_capture_topic_end_offsets matching.commands "$risk_duplicate_first_baseline"
...
INSERT INTO risk_service.outbox (
  ...
  (4, '${risk_duplicate_event_id}', 'matching.commands', 'risk-duplicate', 0,
   decode('7269736b2d6475706c69636174652d7631', 'hex'), 'simplematch.matching.runtime.v1.MatchingCommand',
...
INSERT INTO account_service.outbox (
  ...
  (4, '${account_duplicate_event_id}', 'account.lifecycle', 'account-duplicate', NULL,
   decode('6163636f756e742d6475706c69636174652d7632', 'hex'), 'simplematch.account.v2.AccountLifecycleEvent',
...
cdc_capture_topic_end_offsets matching.commands "$risk_duplicate_redelivery_baseline"

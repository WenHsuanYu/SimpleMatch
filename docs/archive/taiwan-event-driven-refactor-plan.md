...
> Archived on 2026-09-04. This document records historical implementation planning and is not a
> current source of truth. See [`docs/archive/README.md`](README.md) for the active replacements.

  ...
  private fun registerRootTasks(project: Project, serviceTaskPrefix: String) {
    ...
    val taskMappings =
        listOf(
            ...
            TaskMapping("flywayRepair", serviceTaskPrefix + "FlywayRepair", "Repairs Flyway schema history metadata."),
            TaskMapping("flywayBaseline", serviceTaskPrefix + "FlywayBaseline", "Baselines an existing schema for Flyway."),

...
public final class MarketSnapshotReadinessHealthIndicator implements HealthIndicator {
  ...
  /**
   * Returns an out-of-service health result for missing, stale, or invalid authoritative reference
   * data.
   */
  @Override
  public Health health() {
    ...
    if (current.isPresent()) {
      ...
      if (!PreparedMarketSnapshot.checksumFor(snapshot.canonicalContent())
          .equals(snapshot.checksum())) {

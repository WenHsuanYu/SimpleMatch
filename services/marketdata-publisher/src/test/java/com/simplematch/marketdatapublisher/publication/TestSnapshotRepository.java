...
final class TestSnapshotRepository implements MarketSnapshotRepository {
  ...
  private void awaitVersionRace(CyclicBarrier barrier) {
    try {
      ...
      throw new IllegalStateException("interrupted while synchronizing competing snapshot publishers", exception);
    } catch (BrokenBarrierException | TimeoutException exception) {
      throw new IllegalStateException("competing snapshot publisher synchronization failed", exception);
    }
  }
}

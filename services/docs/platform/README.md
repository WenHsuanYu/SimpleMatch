...
These documents define the intended cross-cutting platform. They distinguish target operating rules from repository
execution plans, phase gates, task tracking, and certification evidence.
...
- [Development environment](development-environment.md) — local toolchain, repository layout, and build expectations.

...
public final class QuickFixGatewayStartupLifecycle implements SmartLifecycle {
    private static final Logger logger = LoggerFactory.getLogger(QuickFixGatewayStartupLifecycle.class);
    ...
    public void start() {
        ...
        try {
            ...
            throw new IllegalStateException("quickfix-gateway startup recovery failed owner_id=" + ownerId, e);
        }
    }

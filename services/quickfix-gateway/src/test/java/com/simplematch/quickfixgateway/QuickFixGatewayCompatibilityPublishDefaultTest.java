...
class QuickFixGatewayCompatibilityPublishDefaultTest {
  ...
  @Autowired
  private OrdersCommandPublisher ordersCommandPublisher;

  @Autowired
  private MatchingExecutionConsumer matchingExecutionConsumer;

  @Autowired
  private QuickFixGatewayStartupRecovery startupRecovery;

  @DisplayName("compatibility publish is disabled by default, but the matching executions consume path remains available")
  @Test

...
class QuickFixGatewayReadinessHealthIndicatorTest {
  ...
  void readinessStaysOutOfServiceUntilStartupRecoveryCompletes() {
    ...
    final QuickFixGatewayReadinessHealthIndicator healthIndicator =
        new QuickFixGatewayReadinessHealthIndicator(startupState, false, () -> false);
  ...
  void readinessRequiresQuickFixAcceptorWhenEnabled() {
    ...
    final QuickFixGatewayReadinessHealthIndicator healthIndicator =
        new QuickFixGatewayReadinessHealthIndicator(startupState, true, () -> false);
  ...
  void readinessBecomesUpWhenRecoveryIsCompleteAndAcceptorIsRunning() {
    ...
    final QuickFixGatewayReadinessHealthIndicator healthIndicator =
        new QuickFixGatewayReadinessHealthIndicator(startupState, true, () -> true);

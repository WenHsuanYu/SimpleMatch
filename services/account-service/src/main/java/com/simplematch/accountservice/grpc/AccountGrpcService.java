...
public class AccountGrpcService extends AccountServiceGrpc.AccountServiceImplBase {
    ...
    public void getLimits(
            ...
            StreamObserver<GetLimitsResponse> responseObserver) {
        try {
            ...
            responseObserver.onError(Status.INTERNAL
                    .withDescription("failed to read account limits")
                    .asRuntimeException());
        }
    }
    ...
    public void getPositions(
            ...
            StreamObserver<GetPositionsResponse> responseObserver) {
        try {
            ...
            responseObserver.onError(Status.INTERNAL
                    .withDescription("failed to read account positions")
                    .asRuntimeException());
        }
    }
    ...
    public void releaseReservation(
        ...
        try {
            ...
            responseObserver.onError(Status.INTERNAL
                    .withDescription("failed to release reservation")
                    .asRuntimeException());
        }
    }
    ...
    public void applyFill(
            ...
            StreamObserver<ApplyFillResponse> responseObserver) {
        try {
            final ReservationRecord reservation = reservationService.applyFill(new ApplyFillOperation(
                    new ReservationIdentity(
                            new ReservationIdentity.RequestId(request.getRequestId()),
                            new ReservationIdentity.ReservationId(request.getReservationId()),
                            new ReservationIdentity.OrderId(request.getOrderId())),
            ...
            responseObserver.onNext(ApplyFillResponse.newBuilder()
                    .setRequestId(reservation.requestId()).setReservationId(reservation.reservationId())
                    .setStatus(reservation.status()).build());
            responseObserver.onCompleted();
        } catch (UnsupportedOperationException unsupported) {

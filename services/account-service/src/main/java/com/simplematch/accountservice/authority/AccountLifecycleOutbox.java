...
public final class AccountLifecycleOutbox {
  ...
  public AccountLifecycleOutbox(
      UUID eventId, String topic, String messageKey, byte[] payload, String payloadType,
      String headersJson, String aggregateType, String aggregateId, long createdAtUnixMs) {
   ...
   */
  public long createdAtUnixMs() { return createdAtUnixMs; }

...
/** Adapts matching execution events to the Account Authority reservation use cases. */
@Service
...
public class AccountMatchingExecutionApplicationService implements AccountLifecycleApplier {
  ...
  /** Applies one matching fill or terminal outcome through the account transaction boundary. */

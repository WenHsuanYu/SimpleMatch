 ...
 *
 * @param reservationId the persisted reservation identifier; currently aligned with {@code order_id}
...
public record ReservationRecord(
  ...
  public static ReservationRecord accepted(ReserveOperation operation, long createdAtUnixMs) {
    final BigDecimal reservedNotional = operation.limitPrice() == null
        ? BigDecimal.ZERO

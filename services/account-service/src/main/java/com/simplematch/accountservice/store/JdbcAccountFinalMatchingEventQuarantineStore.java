...
/** Persists Account final-event raw evidence before a critical Kafka partition remains stopped. */
public final class JdbcAccountFinalMatchingEventQuarantineStore implements QuarantineStore {
  private final JdbcTemplate jdbcTemplate;

  /** Creates the Account final-event quarantine adapter. */
  public JdbcAccountFinalMatchingEventQuarantineStore(JdbcTemplate jdbcTemplate) {
  ...
  public List<DeliveryPosition> loadOpenPositions(String consumerName) {
    return jdbcTemplate.query(
        ...
        FROM account_service.matching_event_consumer_quarantines
  ...
  public void markRecovered(DeliveryPosition position, long recoveredAtUnixMs) {
    if (jdbcTemplate.update(
            """
            UPDATE account_service.matching_event_consumer_quarantines
      ...
      throw new IllegalStateException(
          "Account final-event quarantine recovery found no open record");
    }
  }

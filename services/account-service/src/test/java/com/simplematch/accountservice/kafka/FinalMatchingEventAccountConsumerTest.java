...
/** Verifies Account consumes the native final-event record before committing Kafka. */
class FinalMatchingEventAccountConsumerTest {
  ...
  @Test
  void acknowledgesNativeTradeOnlyAfterAccountAuthorityCompletes() throws IOException {

 ...
 *     RPC and storage boundaries; this is currently the same underlying value as the ingress {@code
 *     command_id}
...
public record SubmissionResult(
   ...
   */
  /**
   * @deprecated Use the canonical record constructor; retained for wire compatibility tracked by
   *     issue #21.
   */

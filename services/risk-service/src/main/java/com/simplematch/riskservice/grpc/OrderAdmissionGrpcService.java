...
public final class OrderAdmissionGrpcService extends OrderAdmissionServiceGrpc.OrderAdmissionServiceImplBase {
    ...
    private OrderAdmissionResponse toResponse(AdmissionResult result) {
        ...
        if (result.state() == AdmissionState.ACCEPTED) {
            return OrderAdmissionResponse.newBuilder()
                    .setAccepted(OrderAdmissionAccepted.newBuilder()
    ...
    private OrderAdmissionResponse rejection(RejectedAdmission rejection) {
        ...
        return OrderAdmissionResponse.newBuilder()
                .setRejected(OrderAdmissionRejected.newBuilder()
                        .setMetadata(metadata)
                        ...
                        .setReason(com.simplematch.contracts.orders.v2.AdmissionRejectReason

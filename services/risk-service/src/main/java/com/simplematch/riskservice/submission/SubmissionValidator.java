...
public final class SubmissionValidator {
        ...
        return new SubmissionDecision(
                new SubmissionResult(
                        new SubmissionReference(
                                payload.commandIdValue(),
                                payload.orderIdValue(),
                                resolvedCommandType),
    ...
    private SubmissionDecision rejected(
        ...
        return new SubmissionDecision(
                new SubmissionResult(
                        new SubmissionReference(
                                new SubmissionCommand.CommandId(
                                        persistedIdentifier(payload.commandId())),
                                new SubmissionCommand.OrderId(
                                        persistedIdentifier(payload.orderId())),
                        ...
                        new PersistedFixIdentity(
                                new SubmissionCommand.ClOrdId(
                                        persistedBusinessKeyIdentifier(payload.clOrdId())),
                                new SubmissionCommand.OrigClOrdId(
                                        persistedFixIdentity(payload.origClOrdId())),
                    ...
                    new SubmissionRejection(
                            ...
                            new SubmissionRejection.Detail(
                                    oversizedIdentifierMessage(
                                            "request_id", MAX_PERSISTED_IDENTIFIER_LENGTH))));
        }
        ...
        if (exceedsPersistedIdentifierLength(payload.orderId())) {
            return rejected(
                    ...
                    new SubmissionRejection(
                            ...
                            new SubmissionRejection.Detail(
                                    oversizedIdentifierMessage(
                                            "order_id", MAX_PERSISTED_IDENTIFIER_LENGTH))));
        }

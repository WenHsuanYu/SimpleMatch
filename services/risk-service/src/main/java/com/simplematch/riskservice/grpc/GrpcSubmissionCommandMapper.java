...
final class GrpcSubmissionCommandMapper {
  ResolvedSubmissionCommand map(
      OrderCommand command, com.simplematch.contracts.orders.v1.CommandType expectedType) {
    final CommandType normalizedExpectedType = toCommandType(expectedType);
    final ResolvedSubmissionCommand typedEmptyCommand =
        ResolvedSubmissionCommand.typedEmpty(normalizedExpectedType);
  ...
  private static TimeInForce toTimeInForce(
      com.simplematch.contracts.common.v1.TimeInForce timeInForce) {
    if (timeInForce == null) {
  ...
  private static CommandType toCommandType(
      com.simplematch.contracts.orders.v1.CommandType commandType) {
    if (commandType == null) {
